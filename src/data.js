...
jQuery.extend({
   ...
   flash：早期的jQuery将所有的Object标签纳入雷区，后来发现IE下的flash还是可以自定义属性的，于是针对IE的flash还是网开一面，放过了IE的flash，IE下加载flash的时候，需要对object指定一个叫做classId的属性，它的值为：clsid:D27CDB6E-AE6D-11cf-96B8-444553540000。
	 *
	 * http://www.cnblogs.com/silin6/p/jQuery_data.html
	 *
	 * 测试在chrome 55 中为 embed / applet 元素设置属性完全没有问题
	 * */
	noData: {
		"embed": true,
		// Ban all objects except for Flash (which handle expandos)
		// "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" 是 flash 控件的 ID , 对应系统注册表中的 ID， 可以参照此文 http://www.cnblogs.com/zqzjs/p/5034345.html
	...
	hasData: function( elem ) {
		/**
		 * 如果 ele.nodeType 为真则表示 element 是页面元素，否者是 js 对象
		 * */
